...
class AppColor {
  ...
  static const PrimaryDark = Color(0xff8F0202);
  //Color(0xff451A35);
  Color colorPrimary() {
    return Color(0xff8F0202);
      //Color(0xff451A35);
  }
  Color colorSecondary(){
    return Color(0xffFFC22A);
  }
...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff8F0202);
  static const Color secondary = Color(0xff8F0202);
