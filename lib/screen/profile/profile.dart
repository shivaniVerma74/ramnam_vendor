                                          ...
                                          children: [
                                            ...
                                            Column(
                                             ...
                                             type == "1"?  Column(
                                                ...
                                                profileModel!.data![0].adharCard == null || profileModel!.data![0].adharCard == ""
                                                    ? SizedBox.shrink()
                                                    : Container(
                                                    height: 50,
                                                    width: 80,
                                                ...
                                                profileModel!.data![0].adharCardBack == null || profileModel!.data![0].adharCardBack == ""
                                                    ? SizedBox.shrink()
                                                    : Container(
                                                  height: 50,
                                                  width: 80,
                                                  child: ClipRRect(borderRadius:
                                                  BorderRadius.circular(6), child:
                                                  Image.network("${profileModel!.data![0].adharCardBack.toString()}", fit:
                                                  BoxFit.fill,
                                                  ),
                                                  ),
                                                ),
                                                ...
                                                profileModel!.data![0].pancard == null || profileModel!.data![0].pancard == ""
                                                    ? SizedBox.shrink()
                                                    : Container(
                                                    height: 50,
                                                    width: 80,
