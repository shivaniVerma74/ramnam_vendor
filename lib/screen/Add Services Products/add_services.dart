...
class _AddServicesState extends State<AddServices> {
  ...
  TextEditingController perHourChargeController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: AppColor().colorPrimary(),
        title: Text("Request Service", style: TextStyle(
          ...
          child:SingleChildScrollView(
            ...
            child: Column(
              ...
              type == "7" || type == "6" || type == "8"  || type == "5" ? SizedBox.shrink():SizedBox(
                ...
                type == "7" || type == "6" || type == "8"  || type == "5"? SizedBox.shrink():Padding(
                  ...
                  child: Container(
                    ...
                    child: DropdownButton(
                      ...
                      // Array list of items
                      items: ['Commercial','Residence'].map((items) {
                ...
                SizedBox(height: 12,),
           type == "6" ?     Text("Per Hour Charge",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500),) : SizedBox.shrink(),
                type == "6" ?    SizedBox(height: 8,) : SizedBox.shrink(),
                type == "6" ?    TextFormField(controller: perHourChargeController,
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(
