...
// You can request multiple permissions at once.
  ...
  editServices()async{
    ...
    request.fields.addAll({
      ...
      'services_id': widget.productsModel!.id.toString(),
  ...
  void initState(){
    ...
    mainPlanValue = widget.productsModel!.serviceType == "" || widget.productsModel!.serviceType == "null" ||widget.productsModel!.serviceType == null ? null : widget.productsModel!.serviceType.toString();
   // descriptionController.text = widget.productsModel!.description.toString();
    // subCategoryValue =  widget.productsModel!.subId.toString();
  }

  String? mainPlanValue;
  ...
  Widget build(BuildContext context) {
    print("main values data here ${mainPlanValue}");
    ...
    return Scaffold(
      ...
      body:   Container(
          ...
          type == "7" ? SizedBox.shrink() :      Text(
                ...
                type == "7" ? SizedBox.shrink() :     Padding(
                  ...
                  child: Container(
                    ...
                    child: DropdownButton(
                      ...
                      // Array list of items
                      items:
                      ['commercial','residence'].map((items) {
