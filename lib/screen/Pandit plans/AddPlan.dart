...
class _AddPlansState extends State<AddPlans> {
  ...
  List<String> mainCatList = [
    "Residence",
    "Commercial"
  ];

  List<dynamic> serviceList = [];
  List<dynamic> servicelistNew = [];
...
// You can request multiple permissions at once.
  ...
  VendorServicesModel? vendorServicesModel;
  Future getServices() async {
    ...
    print("this is request !! ${request.fields} and ${Apipath.getServicesUrl}");
    http.StreamedResponse response = await request.send();
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        vendorServicesModel = datas;
      });
      serviceList.clear();
      for(var i=0;i<vendorServicesModel!.products!.length;i++){
        serviceList.add(vendorServicesModel!.products![i]);
      }
  ...
  addPlansfunction()async{
    ...
    String servicesData = servicelistNew.join(",");
    print("service data here ${servicesData}");
          ...
          child: Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: DropdownButton(
                          ...
                          hint: Text("Select main plan"),
                          // Array list of items
                          items:
                          mainCatList.map((items) {
                  ...
                  //     height: 12,
                  //   ),
                  // vendorServicesModel ==  null ? SizedBox() :  Padding(
                  //     padding: const EdgeInsets.only(top: 5.0, bottom: 10),
                  //     child: Container(
                  //       height: 60,
                  //       padding: EdgeInsets.only(left: 10),
                  ...
                  //         // Array list of items
                  //         items:
                  //         vendorServicesModel!.products!.map((items) {
                  //           return DropdownMenuItem(
                  //             value: items.id,
                  ...
                  //                 SizedBox(width: 5,),
                  //                 Text(items.artistName.toString()),
                  //               ],
                  //             )),
                  //           );
                  //         }).toList(),
                  ...
                  //   ),
                    ...
                    Container(
                      ...
                      child: CustomSearchableDropDown(
                        ...
                        // ),
                        dropDownMenuItems: serviceList.map((item) {
                        ...
                        onChanged: (value){
                          ...
                          {
                            setState(() {
                              serviceIdList = jsonDecode(value);
                              print("ooooooooooooooo ${serviceIdList}");
                            });
                            for(var i=0;i<serviceIdList.length;i++){
                              servicelistNew.add(serviceIdList[i]['id'].toString());
                              print("ok now here ${servicelistNew}");
                            }
                          }
                          else{
                          //  setState(() {
                    ...
                    SizedBox(height: 5,),
                    serviceIdList.length == 0 ? SizedBox() : Container(
                      height: 30,
                      child: ListView.builder(
                          itemCount: serviceIdList.length,
                        ...
                        return  Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text("${serviceIdList[i]['artist_name']}"),
                              // SizedBox(width: 5,),
                              // InkWell(
                              //     onTap: (){
                              //       setState(() {
                              //         serviceIdList.remove(serviceIdList[i]['id']);
                              //         servicelistNew.remove(serviceIdList[i]);
                              //       });
                              //     },
